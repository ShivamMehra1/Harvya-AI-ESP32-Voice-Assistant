...
#ifdef CONFIG_Harvya AI_ENABLE_CAMERA_DEBUG_MODE
#undef LOG_LOCAL_LEVEL
#define LOG_LOCAL_LEVEL MAX(CONFIG_LOG_DEFAULT_LEVEL, ESP_LOG_DEBUG)
#endif  // CONFIG_Harvya AI_ENABLE_CAMERA_DEBUG_MODE
#include <esp_log.h> // should be after LOCAL_LOG_LEVEL definition

#ifdef CONFIG_Harvya AI_ENABLE_ROTATE_CAMERA_IMAGE
#ifdef CONFIG_IDF_TARGET_ESP32P4
#include "driver/ppa.h"
#if defined(CONFIG_Harvya AI_CAMERA_IMAGE_ROTATION_ANGLE_90)
#define IMAGE_ROTATION_ANGLE (PPA_SRM_ROTATION_ANGLE_270)
#elif defined(CONFIG_Harvya AI_CAMERA_IMAGE_ROTATION_ANGLE_270)
#define IMAGE_ROTATION_ANGLE (PPA_SRM_ROTATION_ANGLE_90)
#else
#error "CONFIG_Harvya AI_CAMERA_IMAGE_ROTATION_ANGLE is not set"
#endif  // angle
#else   // target
...
#endif  // angle
#endif  // target
#endif  // CONFIG_Harvya AI_ENABLE_ROTATE_CAMERA_IMAGE


#define TAG "EspVideo"

#if defined(CONFIG_CAMERA_SENSOR_SWAP_PIXEL_BYTE_ORDER) || defined(CONFIG_Harvya AI_ENABLE_CAMERA_ENDIANNESS_SWAP)
#warning \
    "CAMERA_SENSOR_SWAP_PIXEL_BYTE_ORDER or CONFIG_Harvya AI_ENABLE_CAMERA_ENDIANNESS_SWAP is enabled, which may cause image corruption in YUV422 format!"
#endif

#if CONFIG_Harvya AI_ENABLE_CAMERA_DEBUG_MODE
...
#if defined(CONFIG_Harvya AI_ENABLE_ROTATE_CAMERA_IMAGE) && defined(CONFIG_SOC_PPA_SUPPORTED)
    auto get_rank = [](uint32_t fmt) -> int {
        switch (fmt) {
            ...
            case V4L2_PIX_FMT_RGB565:
                return 1;
#ifdef CONFIG_Harvya AI_ENABLE_HARDWARE_JPEG_ENCODER
            case V4L2_PIX_FMT_YUV420:  // 软件 JPEG 编码器不支持 YUV420 格式
                return 2;
#endif  // CONFIG_Harvya AI_ENABLE_HARDWARE_JPEG_ENCODER
    ...
    auto get_rank = [](uint32_t fmt) -> int {
        switch (fmt) {
            ...
            case V4L2_PIX_FMT_YUV420:
                return 13;
#endif  // CONFIG_Harvya AI_ENABLE_HARDWARE_JPEG_ENCODER
#ifdef CONFIG_Harvya AI_CAMERA_ALLOW_JPEG_INPUT
            case V4L2_PIX_FMT_JPEG:
                return 5;
#endif  // CONFIG_Harvya AI_CAMERA_ALLOW_JPEG_INPUT
            case V4L2_PIX_FMT_GREY:
                return 20;
            default:
                return 1 << 29;  // unsupported
    ...
    for (int i = 0; i < 3; i++) {
        ...
        if (i == 2) {
            ...
            switch (sensor_format_) {
                ...
                case V4L2_PIX_FMT_JPEG:
#endif  // CONFIG_Harvya AI_CAMERA_ALLOW_JPEG_INPUT
#ifdef CONFIG_Harvya AI_ENABLE_CAMERA_ENDIANNESS_SWAP
                {
...
#endif  // CONFIG_Harvya AI_ENABLE_CAMERA_ENDIANNESS_SWAP
