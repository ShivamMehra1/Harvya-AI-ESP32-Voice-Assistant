...
#if CONFIG_Harvya AI_ETH_PHY_IP101
...
static eth_esp32_emac_config_t CreateEmacConfig() {
    ...
    config.smi_gpio.mdc_num = CONFIG_Harvya AI_ETH_MDC_GPIO;
    config.smi_gpio.mdio_num = CONFIG_Harvya AI_ETH_MDIO_GPIO;
...
void EthernetBoard::NetworkTask() {
    ...
    phy_config.phy_addr = CONFIG_Harvya AI_ETH_PHY_ADDR;
    phy_config.reset_gpio_num = CONFIG_Harvya AI_ETH_PHY_RST_GPIO;
