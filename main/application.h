...
/**
 * @brief Harvya AI Application class
 *
 * Main application singleton that manages the device lifecycle,
 * including networking, audio, display, and AI interactions.
 */
class Application {
public:
    ...
    /**
     * Initialize the Harvya AI application
